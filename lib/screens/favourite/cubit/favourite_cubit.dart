...
class FavouriteCubit extends Cubit<FavouriteState> {
  ...
  FavouriteCubit() : super(FavouriteInitial()) {
    ...
    favoriteCourses = List<FeaturedModel>.from(
        box.get(favkey, defaultValue: <dynamic>[]) as List<dynamic>);
  }
