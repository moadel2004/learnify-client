...
void main() async {
  ...
  // 2. Initialize Hive once
  await Hive.initFlutter();

  // Register Adapters before opening boxes
  Hive.registerAdapter(FeaturedModelAdapter());
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => HelpCenterCubit(this)),
        BlocProvider(create: (context) => SettingContentCubit()),
        BlocProvider(create: (context) => ValidatePasswordCubit()),
        BlocProvider(create: (context) => TabChangeCubit()),
          ...
          return BlocBuilder<LanguageCubit, LanguageState>(
            builder: (context, state) {
              return GetMaterialApp(
                ...
                home: SplashScreen(), // or widget.initialScreen to skip splash
              );
            },
          );
        },
